          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-start">
            <div className="md:col-span-1">
              ...
              <p className="text-slate-700 text-sm">
                Forward receipt photos or online grocery order confirmations from your registered forwarding address — our AI extracts the details automatically and processes them in the background.
              </p>
              <p className="text-slate-700 text-sm mt-2">
                To find or configure your personal forwarding address, visit Account &gt; Forwarding in the app.
              </p>
            </div>
            ...
            <div className="md:col-span-2">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <FeatureCard icon={Shield} title="Background processing & Secure">
                  Your receipts are processed in the background. We only accept forwarded receipts from verified account forwarding addresses to protect your account.
                </FeatureCard>
                ...
                <FeatureCard icon={Mail} title="How to use">
                  Forward one receipt per email from your registered forwarding address (see Account &gt; Forwarding). We'll take care of the rest.
                </FeatureCard>
              </div>
            </div>
          </div>
